...
def formats_html():
    body = (
        ...
        "texture companion files. Masked textures use binary transparency. "
        "Sequence animation is not loaded yet; models show their bind pose.</p>"
        "<h2>SMD</h2>"
...
def about_html():
    body = (
        ...
        "<h2>What it reads</h2>"
        "<p>Compiled Source models (.mdl, .vvd, .vtx), GoldSrc Half-Life models (.mdl), "
